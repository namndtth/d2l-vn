...
Tuy nhiên, ở đây chúng ta không cần có nhân, kết quả đầu ra hoặc là giá trị lớn nhất hoặc là giá trị trung bình cho mỗi vùng trong giá trị đầu vào.
*dịch đoạn phía trên*
...
-->
Tại cùng thời điểm, chúng tôi cũng thực hiện thí nghiệm với tầng gộp trung bình.
*dịch đoạn phía trên*
